...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface ITreasuryOracleInterface extends Interface {
    getFunction(nameOrSignature: "pdukaUsd"): FunctionFragment;
  ...
  export interface ITreasuryOracle extends BaseContract {
    
    connect(runner?: ContractRunner | null): ITreasuryOracle;
    waitForDeployment(): Promise<this>;

    interface: ITreasuryOracleInterface;
